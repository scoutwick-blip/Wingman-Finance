  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <div className="text-center space-y-2">
        <h3 className="text-3xl font-black text-slate-900 tracking-tighter uppercase italic">Wingman AI</h3>
        <p className="text-slate-500 font-bold uppercase text-[10px] tracking-[0.3em]">Insights & Guidance</p>
      </div>
      ...
      <div className="bg-slate-900 p-10 rounded-3xl text-white shadow-xl relative overflow-hidden border-b-8 border-indigo-600">
        ...
        <div className="relative z-10 flex flex-col items-center text-center space-y-6">
          ...
          <div className="space-y-2">
            <h4 className="text-lg font-black uppercase tracking-widest">Financial Health Check</h4>
          ...
          <button 
            ...
            className="bg-indigo-600 text-white px-10 py-4 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] shadow-lg hover:bg-indigo-700 transition-all active:scale-95 disabled:opacity-50"
          >
      ...
      {loading && (
        <div className="flex flex-col items-center py-20 space-y-4">
          ...
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Processing history...</p>
        </div>
      )}
      ...
      {advice && !loading && (
        <div className="grid grid-cols-1 gap-6 animate-in fade-in slide-in-from-bottom-6 duration-500">
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
            <h5 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-4">Advisor Summary</h5>
            <p className="text-slate-800 leading-relaxed font-bold italic border-l-4 border-indigo-500 pl-6">"{advice.summary}"</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
              <h5 className="text-[10px] font-bold text-emerald-600 uppercase tracking-widest mb-6">Recommendations</h5>
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
              <h5 className="text-[10px] font-bold text-rose-500 uppercase tracking-widest mb-6">Budget Alerts</h5>
              {advice.alerts.length > 0 ? (
                ...
                <p className="text-xs text-slate-400 font-bold uppercase italic tracking-widest">All systems go. No alerts.</p>
              )}
            </div>
          </div>
        </div>
